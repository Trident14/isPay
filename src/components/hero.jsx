...
const Hero = () => {
  return (
    <section id="home" className="py-20 px-8 bg-gray-900">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
        {/* Left Side */}
        <div className="text-left max-w-xl">
          <h1 className="text-5xl font-bold leading-tight text-white">
            Banking Made <span className="text-blue-600">Simple</span> and <span className="text-blue-400">Secure</span>
          </h1>
          ...
          <div className="mt-8 flex space-x-4">
            ...
            <button className="border border-gray-500 hover:border-blue-600 text-white px-6 py-3 rounded-lg font-medium transition-colors">
              Learn More
            </button>
          </div>
        </div>
        ...
        <div className="mt-12 md:mt-0">
          <div className="bg-gray-800 rounded-lg p-6 shadow-lg max-w-lg mx-auto">
            <p className="text-lg text-gray-400">Current Balance</p>
            <h2 className="text-4xl font-semibold text-white">
              $24,895.50 <span className="text-sm text-gray-400">USD</span>
            </h2>
            <div className="mt-4">
              <p className="text-green-400">+ $250.00</p>
              <p className="text-red-400">- $120.00</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-16 flex justify-between text-center max-w-6xl mx-auto">
        ...
        <div className="flex-1">
          <h3 className="text-3xl font-bold text-white">$10B+</h3>
